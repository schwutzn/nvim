...
4. install [VSBuildTools](https://aka.ms/vs/stable/vs_BuildTools.exe) ("Desktop development with C++" node, make sure the win sdk is also selected. this installs the cl.exe needed to build parsers)
